  ...
  const { error: issuesError } = await supabase.from("issues").insert([
    {
      ...
      description:
        "Near the intersection with Kuzman Josifovski. Vehicles are forced to swerve into oncoming lane. Dangerous especially at night.",
      district: "Center",
      category: "road",
      status: "open",
    },
    {
      ...
      description:
        "Water has been running for 3 days. Basements are flooding. Residents cannot reach the utility company.",
      district: "Varoš",
      category: "water",
      status: "progress",
    },
    {
      ...
      description:
        "All 12 streetlights on the main road have been dark for 2 weeks. Pedestrians and cyclists at risk after dark.",
      district: "Trizla",
      category: "power",
      status: "open",
    },
    {
      ...
      description:
        "Bins have not been emptied in 10 days. Waste is spilling onto pathways. Children play here.",
      district: "Točila",
      category: "garbage",
      status: "open",
    },
    {
      ...
      description:
        "The wall collapsed after heavy rain two weeks ago. Path is partially blocked and unstable. Risk of further collapse.",
      district: "Rid",
      category: "road",
      status: "open",
    },
    {
      title: "Playground equipment broken at Tipski central park",
      description:
        "The slide has a cracked support beam and the swing chains are detached. Two children were injured last week.",
      district: "Tipski",
      category: "park",
      status: "resolved",
    },
  ...
  const { error: fundError } = await supabase.from("fund_campaigns").insert([
    {
      ...
      description:
        "Raise funds to replace the crumbling cobblestones on the main pedestrian street. City matched funding confirmed.",
      district: "Center",
      goal_amount: 1200000,
    ...
    },
    {
      ...
      description:
        "Install 15 solar street lights on the 2km ridge path used by hundreds of walkers daily.",
      district: "Trizla",
      goal_amount: 450000,
    ...
    },
    {
      ...
      description:
        "New equipment, rubber safety surface, and shade structure for the park used by 200+ children.",
      district: "Točila",
      goal_amount: 300000,
      raised_amount: 87000,
      status: "active",
