...
/**
 * Standalone shell for the story wizard — used when entering directly from the
 * Позитива right panel (no chooser). Mirrors the ActionModal shell: bottom
 * sheet on mobile, centered card on desktop. The chooser-based entry point
 * embeds <StoryForm/> inside ActionModal instead.
 */
        ...
        <div
          ...
          <div className="flex shrink-0 items-center justify-between border-b border-zinc-200 bg-white px-4 py-3">
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-base font-semibold text-zinc-900">Сподели вест</h2>
            </div>
            <button
              type="button"
              onClick={handleClose}
