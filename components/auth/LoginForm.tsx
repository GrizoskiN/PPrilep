  ...
  if (magicSent) {
    return (
      <div className="text-center space-y-2">
        ...
        <p className="text-xs text-zinc-500">Испративме линк на <strong>{magicEmail}</strong></p>
        <button onClick={() => setMagicSent(false)} className="text-xs underline text-zinc-400">Обидете се повторно</button>
      </div>
    )
  }
