...
const CUSTOM_PANEL_ROUTES: readonly string[] = ["/sponsors", "/kindergarten", "/account", "/about", "/projects", "/positive", "/utility/water", "/utility/garbage", "/utility/electricity", "/recycle", "/kino"];
